...
/**
 * Creates a new participant and adds it to the choreography.
 */
export function createParticipant(injector, attrs) {
  let participant = injector.get('bpmnFactory').create('bpmn:Participant', attrs);

  let choreo = injector.get('canvas').getRootElement();
